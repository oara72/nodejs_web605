'use strict';
    ...
    import { createContactName, createContactEmail, createContactPhoneNumber } from './actions';
    ...
    class Index extends React.Component {
        ...
        */
        ...
        handleEmailChange(e) {
            ...
            this.context.store.dispatch(createContactEmail(email));
        }

        handlePhoneNumberChange(e) {
            let phoneNumber = e.target.value;
            this.context.store.dispatch(createContactPhoneNumber(phoneNumber));
        }
